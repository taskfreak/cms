...
?>
			<div id="user" class="pnl">
				...
				?>
				<li><a href="loguser.php?id=<?php echo $GLOBALS['objUser']->id; ?>">my account</a></li>
				<?php
				...
				<li><a href="/admin/page.php?id=<?php echo $GLOBALS['objPage']->id
					.(($_REQUEST['item'])?('&amp;action=edit&amp;item='.$_REQUEST['item']):''); ?>&amp;backtopage">edit this page</a></li>
				<?php 
				}
				?>
...
?>
			<div id="user" class="panel">
				<p id="auth_lnk"><a href="javascript:togglelogin()">authentication</a></p>
